...
public class UpdateBookingResponse {
    ...
    public void assertUpdatedAdditionalDetailsField(String additionalField){
        ...
        assertEquals(additionalneeds,additionalField);
    }
    public void assertPartiallyUpdatedFields(String firstName,String lastName){
